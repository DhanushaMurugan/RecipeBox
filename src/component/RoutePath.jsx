...
// import chefhat from "../image/chef-hat.png";
// import viewrecipeimg from "../image/viewrecipeimg.jpg";
...
//   const [isIngredientModalOpen, setIsIngredientModalOpen] = useState(false); // State for ingretiant modal
...
//   // Fetch meals by ingredient and open modal
...
//     setIsIngredientModalOpen(false); // Close category modal
...
//             <h2 className="text-2xl font-bold mb-4">Recipes By Incredient</h2>
//             <div className="max-h-96 overflow-y-auto">
//               {loading ? (
//                 <p className="text-center text-gray-500">Loading...</p>
//               ) : (
