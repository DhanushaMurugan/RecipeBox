      ...
      <div className="bg-gray-50">
        ...
        <div className=" flex justify-evenly ">
          ...
          <div className="w-72  text-center">
            ...
            <div className="pt-8">
              <button
                className="w-60 bg-gradient-to-r from-[#734060] to-[#a0527f] text-white py-3 rounded-lg shadow-lg
          ...
          <div className="w-72 text-center">
            ...
            <div className="pt-8">
              <button
                className="w-60 bg-gradient-to-r from-[#734060] to-[#a0527f] text-white py-3 rounded-lg shadow-lg hover:from-[#a0527f]
        ...
        <div>
          ...
          <div>
            <div className="flex items-center justify-center  py-16">
              <button
                class=" font-semibold py-2 w-96 bg-gradient-to-r from-[#734060] to-[#a0527f] text-white py-3 rounded-lg shadow-lg hover:from-[#a0527f]
        hover:to-[#734060] hover:scale-105 transition-transform duration-300 ease-in-out 
               focus:outline-none focus:ring-4 focus:ring-[#734060]/50 text-2xl font-semibold"
